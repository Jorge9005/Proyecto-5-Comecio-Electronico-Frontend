...
const Footer = () => {
    return (<div className="footer-basic">
        ...
        <footer>
            <div className="social"><a href="www.google.com"><i className="icon ion-social-instagram" /></a><a href="www.google.com"><i className="icon ion-social-snapchat" /></a><a href="www.google.com"><i className="icon ion-social-twitter" /></a><a href="#"><i className="icon ion-social-facebook" /></a></div>
